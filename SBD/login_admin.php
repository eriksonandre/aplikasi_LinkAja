...
<nav class="navbar navbar-light" style="background-color: aqua">
  ...
  <table>
  	<tr>
    <td><a href="login.php" class="btn btn-success" style="width: 200px;">User</a></td>
  	</tr>
  </table>
</nav>
<br><br><br><br>
...
<div class="container">
  <form method="post" class="loginform" enctype="multipart/form-data">
    <div class="form-group">
      ...
      <input class="form-control" required type="text" placeholder="Masukkan Username Anda" name="pengguna">
    </div>
    <div class="form-group">
...
<?php
  ...
  if(isset($_POST['btnlogin'])) {
    ...
    $enter = "SELECT * FROM admin WHERE username = '$user_lgn'";
    ...
    if ($count != 0) {
      ...
      echo "<script>alert('Email atau Password Salah');window.location='login_admin.php'</script>";
