...
<br><br>
<div class="container">
  <h1><b>Tagihan PDAM</b></h1><br><br>
  <form method="post" enctype="multipart/form-data">
  <div class="form-group">
    <label for="id_pelanggan">Masukan ID Pelanggan</label>
    <input type="text" class="form-control" required name="id_pelanggan" placeholder="Masukan ID Pelanggan Anda">
  </div>
  <div class="form-group">
    ...
    $id = $pecah['id'];
		...
		if ($count != 0) {
          ...
          saldo='$spengguna'-'$nominal' WHERE id='$id'");
					...
					$result = mysqli_query($koneksi, "INSERT INTO tagihan VALUES(NULL, '1', 'air', '$id', '$npengguna', '$idpelanggan', '$nominal')");
